  ...
  return (
    <>
      ...
      >
        {!loading && (
          <div className="">
            <div className="flex lg:flex-row md:flex-row flex-row lg:items-center justify-between pb-4 border-b border-gray-50 dark:border-gray-700 dark:text-gray-300">
              ...
              <div className=" text-left">
                <h2 className="lg:flex  text-lg font-serif font-semibold mt-4 lg:mt-0 lg:ml-0 md:mt-0">
                  {/* {mode === "dark" ? (
